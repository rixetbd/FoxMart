...
<head>
	...
	<title>Foxic HTML Template - Index Page - Electronics</title>
	<link rel="shortcut icon" type="image/x-icon" href="{{asset('frontend_assets')}}/images/favicon.ico" />
	<!-- Vendor CSS -->
	<link href="{{asset('frontend_assets')}}/css/vendor/bootstrap.min.css" rel="stylesheet">
	<link href="{{asset('frontend_assets')}}/css/vendor/vendor.min.css" rel="stylesheet">
	<!-- Custom styles for this template -->
	<link href="{{asset('frontend_assets')}}/css/style-electronics.css" rel="stylesheet">
	<!-- Custom font -->
	<link href="{{asset('frontend_assets')}}/fonts/icomoon/icons.css" rel="stylesheet">
...
<!-- /Menu Toggle -->
			...
			<div class="col-auto hdr-logo">
				<a href="index.html" class="logo"><img srcset="{{asset('frontend_assets')}}/images/skins/electronics/logo-electronics.png 1x, {{asset('frontend_assets')}}/images/skins/electronics/logo-electronics2x.png 2x" alt="Logo"></a>
			</div>
			<!--navigation-->
...
<!-- /Menu Toggle -->
	...
	<div class="bnr-img"><img src="{{asset('frontend_assets')}}/images/header-banner.png" alt=""></div>
...
<div class="dropdn_language">
	<div class="dropdn dropdn_language dropdn_language--noimg dropdn_caret">
		...
		<div class="dropdn-content">
			<ul>
				<li class="active"><a href="#"><img src="{{asset('frontend_assets')}}/images/flags/en.png" alt="">English</a></li>
				<li><a href="#"><img src="{{asset('frontend_assets')}}/images/flags/sp.png" alt="">Spanish</a></li>
				<li><a href="#"><img src="{{asset('frontend_assets')}}/images/flags/de.png" alt="">German</a></li>
				<li><a href="#"><img src="{{asset('frontend_assets')}}/images/flags/fr.png" alt="">French</a></li>
			</ul>
		</div>
	</div>
</div>
...
<ul class="mmenu mmenu-js">
	...
	<li><a href="index.html">Fashion (Default) Skin</a><span class="submenu-link-image"><img src="{{asset('frontend_assets')}}/images/screen/screen01.png" alt=""></span></li>
	<li><a href="index-sport.html">Sport Skin</a><span class="submenu-link-image"><img src="{{asset('frontend_assets')}}/images/screen/screen-sport.png" alt=""></span></li>
	<li><a href="index-books.html">Books Skin <span class="menu-label  menu-label--color3">NEW</span></a><span class="submenu-link-image"><img src="{{asset('frontend_assets')}}/images/screen/screen-books.png" alt=""></span></li>
	<li><a href="index-electronics.html">Electronics Skin <span class="menu-label  menu-label--color3">NEW</span></a><span class="submenu-link-image"><img src="{{asset('frontend_assets')}}/images/screen/screen-electronics.png" alt=""></span></li>
	<li><a href="index-viping.html">Vaping Skin <span class="menu-label  menu-label--color3">NEW</span></a><span class="submenu-link-image"><img src="{{asset('frontend_assets')}}/images/screen/screen-vaping.png" alt=""></span></li>
	<li><a href="index-pets.html">Pets Skin</a><span class="submenu-link-image"><img src="{{asset('frontend_assets')}}/images/screen/screen-pets.png" alt=""></span></li>
	<li><a href="index-lingeries.html">Lingeries Skin</a><span class="submenu-link-image"><img src="{{asset('frontend_assets')}}/images/screen/screen-lingeries.png" alt=""></span></li>
	<li><a href="index-games.html">Games Skin</a><span class="submenu-link-image"><img src="{{asset('frontend_assets')}}/images/screen/screen-games.png" alt=""></span></li>
	<li><a href="index-helloween.html">Halloween Skin</a><span class="submenu-link-image"><img src="{{asset('frontend_assets')}}/images/screen/screen-halloween.png" alt=""></span></li>
	<li><a href="index-medical.html">Medical Skin</a><span class="submenu-link-image"><img src="{{asset('frontend_assets')}}/images/screen/screen-medical.png" alt=""></span></li>
	<li><a href="index-food.html">Food Market Skin</a><span class="submenu-link-image"><img src="{{asset('frontend_assets')}}/images/screen/screen-food.png" alt=""></span></li>
	<li><a href="index-cosmetics.html">Cosmetics Skin</a><span class="submenu-link-image"><img src="{{asset('frontend_assets')}}/images/screen/screen-cosmetics.png" alt=""></span></li>
	<li><a href="index-fishing.html">Fishing Skin</a><span class="submenu-link-image"><img src="{{asset('frontend_assets')}}/images/screen/screen-fishing.png" alt=""></span></li>
</ul>
<ul class="submenu-list mt-0">
	<li><a href="#">Cups&Mugs Skin <span class="menu-label menu-label--color1">Coming Soon</span></a><span class="submenu-link-image"><img src="{{asset('frontend_assets')}}/images/screen/screen-cups.png" alt=""></span></li>
	<li><a href="#">Bikes Skin <span class="menu-label menu-label--color2">Coming Soon</span></a><span class="submenu-link-image"><img src="{{asset('frontend_assets')}}/images/screen/screen-bikes.png" alt=""></span></li>
	<li><a href="#">T-Shirts Skin <span class="menu-label">Coming Soon</span></a><span class="submenu-link-image"><img src="{{asset('frontend_assets')}}/images/screen/screen-tshirts.png" alt=""></span></li>
	<li><a href="index-02.html">Home page 2</a><span class="submenu-link-image"><img src="{{asset('frontend_assets')}}/images/screen/screen02.png" alt=""></span></li>
	<li><a href="index-03.html">Home page 3</a><span class="submenu-link-image"><img src="{{asset('frontend_assets')}}/images/screen/screen03.png" alt=""></span></li>
	<li><a href="index-04.html">Home page 4</a><span class="submenu-link-image"><img src="{{asset('frontend_assets')}}/images/screen/screen04.png" alt=""></span></li>
	<li><a href="index-05.html">Home page 5</a><span class="submenu-link-image"><img src="{{asset('frontend_assets')}}/images/screen/screen05.png" alt=""></span></li>
	<li><a href="index-06.html">Home page 6</a><span class="submenu-link-image"><img src="{{asset('frontend_assets')}}/images/screen/screen06.png" alt=""></span></li>
	<li><a href="index-07.html">Home page 7</a><span class="submenu-link-image"><img src="{{asset('frontend_assets')}}/images/screen/screen07.png" alt=""></span></li>
	<li><a href="index-08.html">Home page 8</a><span class="submenu-link-image"><img src="{{asset('frontend_assets')}}/images/screen/screen08.png" alt=""></span></li>
	<li><a href="index-09.html">Home page 9</a><span class="submenu-link-image"><img src="{{asset('frontend_assets')}}/images/screen/screen09.png" alt=""></span></li>
	<li><a href="index-10.html">Home page 10</a><span class="submenu-link-image"><img src="{{asset('frontend_assets')}}/images/screen/screen10.png" alt=""></span></li>
	<li><a href="index-rtl.html">Home page RTL</a><span class="submenu-link-image"><img src="{{asset('frontend_assets')}}/images/screen/screen-rtl.png" alt=""></span></li>
</ul>
		</div>
	</li>
					...
					<div class="mmenu-left width-25">
						<div class="mmenu-bnr-wrap">
							<a href="product.html" class="image-hover-scale image-container w-100" style="padding-bottom: 102.91%">
								<img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-srcset="images/skins/electronics/menu/mmenu-bnr-01.png" class="lazyload fade-up" alt="Banner">
							</a>
						</div>
					</div>
		...
		<div class="minicart-drop-content js-dropdn-content-scroll">
			<div class="minicart-prd row">
				<div class="minicart-prd-image image-hover-scale-circle col">
					<a href="product.html"><img class="lazyload fade-up" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/fashion/products/product-01-1.jpg" alt=""></a>
				</div>
			...
			<div class="minicart-prd row">
				<div class="minicart-prd-image image-hover-scale-circle col">
					<a href="product.html"><img class="lazyload fade-up" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/fashion/products/product-16-1.jpg" alt=""></a>
				</div>
				<div class="minicart-prd-info col">
					<div class="minicart-prd-tag">FOXic</div>
...
<div class="page-content">
	...
	<div class="container">
		<div class="collection-grid-2 row justify-content-center">
			<div class="collection-grid-2-item col-9 col-md-quarter col-lg-3">
				<a href="collections.html" target="_self" class="bnr-wrap collection-grid-2-item-inside">
					<div class="collection-grid-2-img image-container image-hover-scale" style="padding-bottom: 77.778%"><img class="lazyload fade-up" data-src="{{asset('frontend_assets')}}/images/skins/electronics/category-img-01.png" data-sizes="auto" alt="Office equipment"></div>
					<h3 class="collection-grid-2-title pb-15 heading-font">Office equipment</h3>
				</a>
			</div>
			<div class="collection-grid-2-item col-9 col-md-quarter col-lg-3">
				<a href="collections.html" target="_self" class="bnr-wrap collection-grid-2-item-inside">
					<div class="collection-grid-2-img image-container image-hover-scale" style="padding-bottom: 77.778%"><img class="lazyload fade-up" data-src="{{asset('frontend_assets')}}/images/skins/electronics/category-img-02.png?" data-sizes="auto" alt="TV"></div>
					<h3 class="collection-grid-2-title pb-15 heading-font">TV</h3>
				</a>
			</div>
			<div class="collection-grid-2-item col-9 col-md-quarter col-lg-3">
				<a href="collections.html" target="_self" class="bnr-wrap collection-grid-2-item-inside">
					<div class="collection-grid-2-img image-container image-hover-scale" style="padding-bottom: 77.778%"><img class="lazyload fade-up" data-src="{{asset('frontend_assets')}}/images/skins/electronics/category-img-03.png" data-sizes="auto" alt="Phones"></div>
					<h3 class="collection-grid-2-title pb-15 heading-font">Phones</h3>
				</a>
			</div>
			<div class="collection-grid-2-item col-9 col-md-quarter col-lg-3">
				<a href="collections.html" target="_self" class="bnr-wrap collection-grid-2-item-inside">
					<div class="collection-grid-2-img image-container image-hover-scale" style="padding-bottom: 77.778%"><img class="lazyload fade-up" data-src="{{asset('frontend_assets')}}/images/skins/electronics/category-img-04.png" data-sizes="auto" alt="Appliances"></div>
					<h3 class="collection-grid-2-title pb-15 heading-font">Appliances</h3>
				</a>
			</div>
			<div class="collection-grid-2-item col-9 col-md-quarter col-lg-3">
				<a href="collections.html" target="_self" class="bnr-wrap collection-grid-2-item-inside">
					<div class="collection-grid-2-img image-container image-hover-scale" style="padding-bottom: 77.778%"><img class="lazyload fade-up" data-src="{{asset('frontend_assets')}}/images/skins/electronics/category-img-05.png" data-sizes="auto" alt="Photo &amp; Video"></div>
					<h3 class="collection-grid-2-title pb-15 heading-font">Photo & Video</h3>
				</a
				></div>
			<div class="collection-grid-2-item col-9 col-md-quarter col-lg-3">
				<a href="collections.html" target="_self" class="bnr-wrap collection-grid-2-item-inside">
					<div class="collection-grid-2-img image-container image-hover-scale" style="padding-bottom: 77.778%"><img class="lazyload fade-up" data-src="{{asset('frontend_assets')}}/images/skins/electronics/category-img-06.png" data-sizes="auto" alt="Audio"></div>
					<h3 class="collection-grid-2-title pb-15 heading-font">Audio</h3>
				</a>
			</div>
			<div class="collection-grid-2-item col-9 col-md-quarter col-lg-3">
				<a href="collections.html" target="_self" class="bnr-wrap collection-grid-2-item-inside">
					<div class="collection-grid-2-img image-container image-hover-scale" style="padding-bottom: 77.778%"><img class="lazyload fade-up" data-src="{{asset('frontend_assets')}}/images/skins/electronics/category-img-07.png" data-sizes="auto" alt="Gaming consoles"></div>
					<h3 class="collection-grid-2-title pb-15 heading-font">Gaming consoles</h3>
				</a>
			</div>
			<div class="collection-grid-2-item col-9 col-md-quarter col-lg-3">
				<a href="collections.html" target="_self" class="bnr-wrap collection-grid-2-item-inside">
					<div class="collection-grid-2-img image-container image-hover-scale" style="padding-bottom: 77.778%"><img class="lazyload fade-up" data-src="{{asset('frontend_assets')}}/images/skins/electronics/category-img-08.png" data-sizes="auto" alt="Air conditioning"></div>
					<h3 class="collection-grid-2-title pb-15 heading-font">Air conditioning</h3>
				</a>
			</div>
			<div class="collection-grid-2-item col-9 col-md-quarter col-lg-3">
				<a href="collections.html" target="_self" class="bnr-wrap collection-grid-2-item-inside">
					<div class="collection-grid-2-img image-container image-hover-scale" style="padding-bottom: 77.778%"><img class="lazyload fade-up" data-src="{{asset('frontend_assets')}}/images/skins/electronics/category-img-09.png" data-sizes="auto" alt="Auto Electronics"></div>
					<h3 class="collection-grid-2-title pb-15 heading-font">Auto Electronics</h3>
				</a>
			</div>
			<div class="collection-grid-2-item col-9 col-md-quarter col-lg-3">
				<a href="collections.html" target="_self" class="bnr-wrap collection-grid-2-item-inside">
					<div class="collection-grid-2-img image-container image-hover-scale" style="padding-bottom: 77.778%"><img class="lazyload fade-up" data-src="{{asset('frontend_assets')}}/images/skins/electronics/category-img-10.png" data-sizes="auto" alt="Portable Electronics"></div>
					<h3 class="collection-grid-2-title pb-15 heading-font">Portable Electronics</h3>
				</a>
			</div>
			<div class="collection-grid-2-item col-9 col-md-quarter col-lg-3">
				<a href="collections.html" target="_self" class="bnr-wrap collection-grid-2-item-inside">
					<div class="collection-grid-2-img image-container image-hover-scale" style="padding-bottom: 77.778%"><img class="lazyload fade-up" data-src="{{asset('frontend_assets')}}/images/skins/electronics/category-img-11.png" data-sizes="auto" alt="Health &amp; Beauty"></div>
					<h3 class="collection-grid-2-title pb-15 heading-font">Health & Beauty</h3>
				</a>
			</div>
			<div class="collection-grid-2-item col-9 col-md-quarter col-lg-3">
				<a href="collections.html" target="_self" class="bnr-wrap collection-grid-2-item-inside">
					<div class="collection-grid-2-img image-container image-hover-scale" style="padding-bottom: 77.778%"><img class="lazyload fade-up" data-src="{{asset('frontend_assets')}}/images/skins/electronics/category-img-12.png" data-sizes="auto" alt="Lightning"></div>
	...
	<div class="prd-inside">
		<div class="prd-img-area">
			<a href="product.html" class="prd-img image-hover-scale image-container">
				<img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/electronics/products/product-01-1.jpg" alt="iPhone X" class="js-prd-img lazyload">
			...
			<div class="prd-circle-labels">
				...
				<a href="#" class="circle-label-qview js-prd-quickview prd-hide-mobile" data-src="{{asset('frontend_assets')}}/ajax/ajax-quickview.html"><i class="icon-eye"></i><span>QUICK VIEW</span></a>
			</div>
		...
		<div class="prd-info">
			<div class="prd-info-wrap">
				...
				<h2 class="prd-title"><a href="product.html">iPhone X</a></h2>
			...
			<div class="prd-hovers">
				<div class="prd-circle-labels">
					...
					<div><a href="#" class="circle-label-qview prd-hide-mobile js-prd-quickview" data-src="{{asset('frontend_assets')}}/ajax/ajax-quickview.html"><i class="icon-eye"></i><span>QUICK VIEW</span></a></div>
				</div>
				<div class="prd-price">
				...
				<div class="prd-action">
					<div class="prd-action-left">
						<form action="#">
							<button class="btn js-prd-addtocart" data-product='{"name": "iPhone X", "path":"images/skins/electronics/products/product-01-1.jpg", "url":"product.html", "aspect_ratio":0.778}'>Add To Cart</button>
						</form>
					</div>
	...
	<div class="prd-inside">
		<div class="prd-img-area">
			<a href="product.html" class="prd-img image-hover-scale image-container">
				<img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/electronics/products/product-02-1.jpg" alt="QLED TV" class="js-prd-img lazyload">
				<div class="foxic-loader"></div>
				<div class="prd-big-circle-labels">
		...
		<div class="prd-info">
			<div class="prd-info-wrap">
				...
				<h2 class="prd-title"><a href="product.html">QLED TV</a></h2>
				<div class="prd-description">
					Quisque volutpat condimentum velit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam nec ante sed lacinia.
				</div>
			</div>
			<div class="prd-hovers">
				...
				<div class="prd-action">
					<div class="prd-action-left">
						<form action="#">
							<button class="btn js-prd-addtocart" data-product='{"name": "QLED TV", "path":"images/skins/electronics/products/product-02-1.jpg", "url":"product.html", "aspect_ratio":0.778}'>Add To Cart</button>
						</form>
					</div>
					<div class="prd-action-right">
						<div class="prd-action-right-inside">
	...
	<div class="prd-inside">
		<div class="prd-img-area">
			<a href="product.html" class="prd-img image-hover-scale image-container">
				<img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/electronics/products/product-03-1.jpg" alt="Microsoft Laptop" class="js-prd-img lazyload">
				<div class="foxic-loader"></div>
				<div class="prd-big-circle-labels">
		...
		<div class="prd-info">
			<div class="prd-info-wrap">
				...
				<h2 class="prd-title"><a href="product.html">Microsoft Laptop</a></h2>
				<div class="prd-description">
					Quisque volutpat condimentum velit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam nec ante sed lacinia.
				</div>
			</div>
			<div class="prd-hovers">
				...
				<div class="prd-action">
					<div class="prd-action-left">
						<form action="#">
							<button class="btn js-prd-addtocart" data-product='{"name": "Microsoft Laptop", "path":"images/skins/electronics/products/product-03-1.jpg", "url":"product.html", "aspect_ratio":0.778}'>Add To Cart</button>
						</form>
					</div>
					<div class="prd-action-right">
						<div class="prd-action-right-inside">
	...
	<div class="prd-inside">
		<div class="prd-img-area">
			<a href="product.html" class="prd-img image-hover-scale image-container">
				<img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/electronics/products/product-04-1.jpg" alt="Smart speaker 50 watts" class="js-prd-img lazyload">
				<div class="foxic-loader"></div>
				<div class="prd-big-circle-labels">
		...
		<div class="prd-info">
			<div class="prd-info-wrap">
				...
				<h2 class="prd-title"><a href="product.html">Smart speaker 50 watts</a></h2>
				<div class="prd-description">
					Quisque volutpat condimentum velit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam nec ante sed lacinia.
				</div>
			</div>
			<div class="prd-hovers">
				...
				<div class="prd-action">
					<div class="prd-action-left">
						<form action="#">
							<button class="btn js-prd-addtocart" data-product='{"name": "Smart speaker 50 watts", "path":"images/skins/electronics/products/product-04-1.jpg", "url":"product.html", "aspect_ratio":0.778}'>Add To Cart</button>
						</form>
					</div>
					<div class="prd-action-right">
						<div class="prd-action-right-inside">
	...
	<div class="prd-inside">
		<div class="prd-img-area">
			<a href="product.html" class="prd-img image-hover-scale image-container">
				<img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/electronics/products/product-05-1.jpg" alt="Black Headphones" class="js-prd-img lazyload">
				<div class="foxic-loader"></div>
				<div class="prd-big-circle-labels">
		...
		<div class="prd-info">
			<div class="prd-info-wrap">
				...
				<h2 class="prd-title"><a href="product.html">Black Headphones</a></h2>
				<div class="prd-description">
					Quisque volutpat condimentum velit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam nec ante sed lacinia.
				</div>
			</div>
			<div class="prd-hovers">
				...
				<div class="prd-action">
					<div class="prd-action-left">
						<form action="#">
							<button class="btn js-prd-addtocart" data-product='{"name": "Black Headphones", "path":"images/skins/electronics/products/product-05-1.jpg", "url":"product.html", "aspect_ratio":0.778}'>Add To Cart</button>
						</form>
					</div>
					<div class="prd-action-right">
						<div class="prd-action-right-inside">
	...
	<div class="prd-inside">
		<div class="prd-img-area">
			<a href="product.html" class="prd-img image-hover-scale image-container">
				<img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/electronics/products/product-06-1.jpg" alt="Laser scanner" class="js-prd-img lazyload">
				<div class="foxic-loader"></div>
				<div class="prd-big-circle-labels">
		...
		<div class="prd-info">
			<div class="prd-info-wrap">
				...
				<h2 class="prd-title"><a href="product.html">Laser scanner</a></h2>
				<div class="prd-description">
					Quisque volutpat condimentum velit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam nec ante sed lacinia.
				</div>
			</div>
			<div class="prd-hovers">
				...
				<div class="prd-action">
					<div class="prd-action-left">
						<form action="#">
							<button class="btn js-prd-addtocart" data-product='{"name": "Laser scanner", "path":"images/skins/electronics/products/product-06-1.jpg", "url":"product.html", "aspect_ratio":0.778}'>Add To Cart</button>
						</form>
					</div>
					<div class="prd-action-right">
						<div class="prd-action-right-inside">
	...
	<div class="container">
		...
		<ul class="brand-carousel js-brand-carousel slick-arrows-aside-simple" data-slick='{"slidesToShow": 5,  "responsive": [{"breakpoint": 992,"settings": {"slidesToShow": 4 }},{"breakpoint": 480,"settings": {"slidesToShow": 2 }}]}'>
			<li>
				<div>
					<img class="lazyload lazypreload" data-src="{{asset('frontend_assets')}}/images/skins/electronics/brand-01.png" data-sizes="auto" alt="Brand">
				</div>
			</li>
			<li>
				<div>
					<img class="lazyload lazypreload" data-src="{{asset('frontend_assets')}}/images/skins/electronics/brand-02.png" data-sizes="auto" alt="Brand">
				</div>
			</li>
			<li>
				<div>
					<img class="lazyload lazypreload" data-src="{{asset('frontend_assets')}}/images/skins/electronics/brand-03.png" data-sizes="auto" alt="Brand">
				</div>
			</li>
			<li>
				<div>
					<img class="lazyload lazypreload" data-src="{{asset('frontend_assets')}}/images/skins/electronics/brand-04.png" data-sizes="auto" alt="Brand">
				</div>
			</li>
			<li>
				<div>
					<img class="lazyload lazypreload" data-src="{{asset('frontend_assets')}}/images/skins/electronics/brand-05.png" data-sizes="auto" alt="Brand">
				</div>
			</li>
			<li>
				<div>
					<img class="lazyload lazypreload" data-src="{{asset('frontend_assets')}}/images/skins/electronics/brand-06.png" data-sizes="auto" alt="Brand">
				</div>
			</li>
		</ul>
	</div>
	...
	<div class="container">
		...
		<div class="prd-grid-wrap position-relative">
			<div class="prd-grid data-to-show-4 data-to-show-lg-3 data-to-show-md-2 data-to-show-sm-2 data-to-show-xs-2 js-category-grid">
				<div class="prd prd--style2 prd-labels--max prd-labels-shadow ">
	<div class="prd-inside">
		<div class="prd-img-area">
			<a href="product.html" class="prd-img image-hover-scale image-container">
				<img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/electronics/products/product-07-1.jpg" alt="Window Air Conditioner" class="js-prd-img lazyload fade-up">
				<div class="foxic-loader"></div>
			...
			<ul class="list-options color-swatch">
				<li data-image="images/skins/electronics/products/product-07-1.jpg" class="active"><a href="#" class="js-color-toggle" data-toggle="tooltip" data-placement="right" title="Color Name"><img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/electronics/products/product-07-1.jpg" class="lazyload fade-up" alt="Color Name"></a></li>
		...
		<div class="prd-info">
			<div class="prd-info-wrap">
				...
				<div class="prd-tag"><a href="#">FOXic</a></div>
				<h2 class="prd-title"><a href="product.html">Window Air Conditioner</a></h2>
				<div class="prd-description">
					Quisque volutpat condimentum velit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam nec ante sed lacinia.
				</div>
				<div class="prd-action">
					<form action="#">
						<button class="btn js-prd-addtocart" data-product='{"name": "Window Air Conditioner", "path":"images/skins/electronics/products/product-07-1.jpg", "url":"product.html", "aspect_ratio":0.778}'>Add To Cart</button>
					</form>
				</div>
			</div>
			<div class="prd-hovers">
				<div class="prd-circle-labels">
					<div><a href="#" class="circle-label-compare circle-label-wishlist--add js-add-wishlist mt-0" title="Add To Wishlist"><i class="icon-heart-stroke"></i></a><a href="#" class="circle-label-compare circle-label-wishlist--off js-remove-wishlist mt-0" title="Remove From Wishlist"><i class="icon-heart-hover"></i></a></div>
					<div class="prd-hide-mobile"><a href="#" class="circle-label-qview js-prd-quickview" data-src="{{asset('frontend_assets')}}/ajax/ajax-quickview.html"><i class="icon-eye"></i><span>QUICK VIEW</span></a></div>
				</div>
				<div class="prd-price">
	...
	<div class="prd-inside">
		<div class="prd-img-area">
			<a href="product.html" class="prd-img image-hover-scale image-container">
				<img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/electronics/products/product-08-1.jpg" alt="Talking Assistant Column" class="js-prd-img lazyload fade-up">
				<div class="foxic-loader"></div>
				<div class="prd-big-squared-labels">
		...
		<div class="prd-info">
			<div class="prd-info-wrap">
				...
				<div class="prd-rating justify-content-center"><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i></div>
				<div class="prd-tag"><a href="#">FOXic</a></div>
				<h2 class="prd-title"><a href="product.html">Talking Assistant Column</a></h2>
				<div class="prd-description">
					Quisque volutpat condimentum velit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam nec ante sed lacinia.
				</div>
				<div class="prd-action">
					<form action="#">
						<button class="btn js-prd-addtocart" data-product='{"name": "Talking Assistant Column", "path":"images/skins/electronics/products/product-08-1.jpg", "url":"product.html", "aspect_ratio":0.778}'>Add To Cart</button>
					</form>
				</div>
			</div>
			<div class="prd-hovers">
	...
	<div class="prd-inside">
		<div class="prd-img-area">
			<a href="product.html" class="prd-img image-hover-scale image-container">
				<img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/electronics/products/product-09-1.jpg" alt="Silent Mouse" class="js-prd-img lazyload fade-up">
				<div class="foxic-loader"></div>
				<div class="prd-big-squared-labels">
			...
			<ul class="list-options color-swatch">
				<li data-image="images/skins/electronics/products/product-09-1.jpg" class="active"><a href="#" class="js-color-toggle" data-toggle="tooltip" data-placement="right" title="Color Name"><img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/electronics/products/product-09-1.jpg" class="lazyload fade-up" alt="Color Name"></a></li>

				<li data-image="images/skins/electronics/products/product-09-2.jpg"><a href="#" class="js-color-toggle" data-toggle="tooltip" data-placement="right" title="Color Name"><img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/electronics/products/product-09-2.jpg" class="lazyload fade-up" alt="Color Name"></a></li>
		...
		<div class="prd-info">
			<div class="prd-info-wrap">
				...
				<div class="prd-rating justify-content-center"><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i></div>
				<div class="prd-tag"><a href="#">FOXic</a></div>
				<h2 class="prd-title"><a href="product.html">Silent Mouse</a></h2>
				<div class="prd-description">
					Quisque volutpat condimentum velit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam nec ante sed lacinia.
				</div>
				<div class="prd-action">
					<form action="#">
						<button class="btn js-prd-addtocart" data-product='{"name": "Silent Mouse", "path":"images/skins/electronics/products/product-09-1.jpg", "url":"product.html", "aspect_ratio":0.778}'>Add To Cart</button>
					</form>
				</div>
			</div>
			<div class="prd-hovers">
	...
	<div class="prd-inside">
		<div class="prd-img-area">
			<a href="product.html" class="prd-img image-hover-scale image-container">
				<img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/electronics/products/product-10-1.jpg" alt="Music Center Pro" class="js-prd-img lazyload fade-up">
				<div class="foxic-loader"></div>
				<div class="prd-big-squared-labels">
			...
			<ul class="list-options color-swatch">
				<li data-image="images/skins/electronics/products/product-10-1.jpg" class="active"><a href="#" class="js-color-toggle" data-toggle="tooltip" data-placement="right" title="Color Name"><img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/electronics/products/product-10-1.jpg" class="lazyload fade-up" alt="Color Name"></a></li>

				<li data-image="images/skins/electronics/products/product-10-2.jpg"><a href="#" class="js-color-toggle" data-toggle="tooltip" data-placement="right" title="Color Name"><img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/electronics/products/product-10-2.jpg" class="lazyload fade-up" alt="Color Name"></a></li>
		...
		<div class="prd-info">
			<div class="prd-info-wrap">
				...
				<div class="prd-rating justify-content-center"><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i></div>
				<div class="prd-tag"><a href="#">FOXic</a></div>
				<h2 class="prd-title"><a href="product.html">Music Center Pro</a></h2>
				<div class="prd-description">
					Quisque volutpat condimentum velit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam nec ante sed lacinia.
				</div>
				<div class="prd-action">
					<form action="#">
						<button class="btn js-prd-addtocart" data-product='{"name": "Music Center Pro", "path":"images/skins/electronics/products/product-10-1.jpg", "url":"product.html", "aspect_ratio":0.778}'>Add To Cart</button>
					</form>
				</div>
			</div>
			<div class="prd-hovers">
	...
	<div class="prd-inside">
		<div class="prd-img-area">
			<a href="product.html" class="prd-img image-hover-scale image-container">
				<img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/electronics/products/product-11-1.jpg" alt="Smart Thermostat" class="js-prd-img lazyload fade-up">
				<div class="foxic-loader"></div>
				<div class="prd-big-squared-labels">
			...
			<ul class="list-options color-swatch">
				<li data-image="images/skins/electronics/products/product-11-1.jpg" class="active"><a href="#" class="js-color-toggle" data-toggle="tooltip" data-placement="right" title="Color Name"><img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/electronics/products/product-11-1.jpg" class="lazyload fade-up" alt="Color Name"></a></li>

				<li data-image="images/skins/electronics/products/product-11-2.jpg"><a href="#" class="js-color-toggle" data-toggle="tooltip" data-placement="right" title="Color Name"><img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/electronics/products/product-11-2.jpg" class="lazyload fade-up" alt="Color Name"></a></li>
		...
		<div class="prd-info">
			<div class="prd-info-wrap">
				...
				<div class="prd-rating justify-content-center"><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i></div>
				<div class="prd-tag"><a href="#">FOXic</a></div>
				<h2 class="prd-title"><a href="product.html">Smart Thermostat</a></h2>
				<div class="prd-description">
					Quisque volutpat condimentum velit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam nec ante sed lacinia.
				</div>
				<div class="prd-action">
					<form action="#">
						<button class="btn js-prd-addtocart" data-product='{"name": "Smart Thermostat", "path":"images/skins/electronics/products/product-11-1.jpg", "url":"product.html", "aspect_ratio":0.778}'>Add To Cart</button>
					</form>
				</div>
			</div>
			<div class="prd-hovers">
	...
	<div class="prd-inside">
		<div class="prd-img-area">
			<a href="product.html" class="prd-img image-hover-scale image-container">
				<img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/electronics/products/product-12-1.jpg" alt="Smart Watch" class="js-prd-img lazyload fade-up">
				<div class="foxic-loader"></div>
				<div class="prd-big-squared-labels">
			...
			<ul class="list-options color-swatch">
				<li data-image="images/skins/electronics/products/product-12-1.jpg" class="active"><a href="#" class="js-color-toggle" data-toggle="tooltip" data-placement="right" title="Color Name"><img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/electronics/products/product-12-1.jpg" class="lazyload fade-up" alt="Color Name"></a></li>

				<li data-image="images/skins/electronics/products/product-12-2.jpg"><a href="#" class="js-color-toggle" data-toggle="tooltip" data-placement="right" title="Color Name"><img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/electronics/products/product-12-2.jpg" class="lazyload fade-up" alt="Color Name"></a></li>
		...
		<div class="prd-info">
			<div class="prd-info-wrap">
				...
				<div class="prd-rating justify-content-center"><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i></div>
				<div class="prd-tag"><a href="#">FOXic</a></div>
				<h2 class="prd-title"><a href="product.html">Smart Watch</a></h2>
				<div class="prd-description">
					Quisque volutpat condimentum velit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam nec ante sed lacinia.
				</div>
				<div class="prd-action">
					<form action="#">
						<button class="btn js-prd-addtocart" data-product='{"name": "Smart Watch", "path":"images/skins/electronics/products/product-12-1.jpg", "url":"product.html", "aspect_ratio":0.778}'>Add To Cart</button>
					</form>
				</div>
			</div>
			<div class="prd-hovers">
	...
	<div class="prd-inside">
		<div class="prd-img-area">
			<a href="product.html" class="prd-img image-hover-scale image-container">
				<img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/electronics/products/product-13-1.jpg" alt="Cable Modem Router" class="js-prd-img lazyload fade-up">
				<div class="foxic-loader"></div>
				<div class="prd-big-squared-labels">
			...
			<ul class="list-options color-swatch">
				<li data-image="images/skins/electronics/products/product-13-1.jpg" class="active"><a href="#" class="js-color-toggle" data-toggle="tooltip" data-placement="right" title="Color Name"><img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/electronics/products/product-13-1.jpg" class="lazyload fade-up" alt="Color Name"></a></li>

				<li data-image="images/skins/electronics/products/product-13-2.jpg"><a href="#" class="js-color-toggle" data-toggle="tooltip" data-placement="right" title="Color Name"><img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/electronics/products/product-13-2.jpg" class="lazyload fade-up" alt="Color Name"></a></li>
		...
		<div class="prd-info">
			<div class="prd-info-wrap">
				...
				<div class="prd-rating justify-content-center"><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i></div>
				<div class="prd-tag"><a href="#">FOXic</a></div>
				<h2 class="prd-title"><a href="product.html">Cable Modem Router</a></h2>
				<div class="prd-description">
					Quisque volutpat condimentum velit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam nec ante sed lacinia.
				</div>
				<div class="prd-action">
					<form action="#">
						<button class="btn js-prd-addtocart" data-product='{"name": "Cable Modem Router", "path":"images/skins/electronics/products/product-13-1.jpg", "url":"product.html", "aspect_ratio":0.778}'>Add To Cart</button>
					</form>
				</div>
			</div>
			<div class="prd-hovers">
	...
	<div class="prd-inside">
		<div class="prd-img-area">
			<a href="product.html" class="prd-img image-hover-scale image-container">
				<img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/electronics/products/product-14-1.jpg" alt="Music Amplifier Box" class="js-prd-img lazyload fade-up">
				<div class="foxic-loader"></div>
				<div class="prd-big-squared-labels">
			...
			<ul class="list-options color-swatch">
				<li data-image="images/skins/electronics/products/product-14-1.jpg" class="active"><a href="#" class="js-color-toggle" data-toggle="tooltip" data-placement="right" title="Color Name"><img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/electronics/products/product-14-1.jpg" class="lazyload fade-up" alt="Color Name"></a></li>

				<li data-image="images/skins/electronics/products/product-14-2.jpg"><a href="#" class="js-color-toggle" data-toggle="tooltip" data-placement="right" title="Color Name"><img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/skins/electronics/products/product-14-2.jpg" class="lazyload fade-up" alt="Color Name"></a></li>
		...
		<div class="prd-info">
			<div class="prd-info-wrap">
				...
				<div class="prd-rating justify-content-center"><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i><i class="icon-star-fill fill"></i></div>
				<div class="prd-tag"><a href="#">FOXic</a></div>
				<h2 class="prd-title"><a href="product.html">Music Amplifier Box</a></h2>
				<div class="prd-description">
					Quisque volutpat condimentum velit. Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Nam nec ante sed lacinia.
				</div>
				<div class="prd-action">
					<form action="#">
						<button class="btn js-prd-addtocart" data-product='{"name": "Music Amplifier Box", "path":"images/skins/electronics/products/product-14-1.jpg", "url":"product.html", "aspect_ratio":0.778}'>Add To Cart</button>
					</form>
				</div>
			</div>
			<div class="prd-hovers">
				...
				<div class="col-lg-4">
					<div class="footer-block">
						<div class="footer-logo">
							<a href="index.html" class="logo"><img srcset="images/skins/electronics/logo-electronics-footer.png 1x, images/skins/electronics/logo-electronics-footer2x.png 2x" alt="Logo"></a>
						</div>
					</div>
				</div>
				<div class="col-lg-10">
		...
		<div class="container">
			<div class="row">
				<div class="col-auto sticky-addcart_image">
					<a href="product.html">
						<img src="{{asset('frontend_assets')}}/images/skins/fashion/products/product-01-1.jpg" alt=""/>
					</a>
				</div>
				...
				<div class="col-auto sticky-addcart_actions">
					...
					<div class="btn-wrap">
						<button class="btn js-prd-addtocart" data-fancybox data-src="{{asset('frontend_assets')}}/#modalCheckOut">Add to cart
						</button>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-auto popup-addedtocart_logo">
					<img src="{{asset('frontend_assets')}}/data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" data-src="{{asset('frontend_assets')}}/images/logo-white-sm.png" class="lazyload fade-up" alt="">
				</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-auto sticky-addcart_image sticky-addcart_image--zoom">
					<a href="#" data-caption="">
						<span class="image-container"><img src="{{asset('frontend_assets')}}/#" alt=""/></span>
					</a>
				</div>
				<div class="col col-sm-5 col-lg-4 col-xl-5 sticky-addcart_info">
			...
			<div class="payment-notification-inside">
				<div class="payment-notification-container">
					<a href="#" class="payment-notification-image js-pn-link">
						<img src="{{asset('frontend_assets')}}/images/products/product-01.jpg" class="js-pn-image" alt="">
					</a>
				...
				<div class="payment-notification-qw prd-hide-mobile js-prd-quickview" data-src="{{asset('frontend_assets')}}/ajax/ajax-quickview.html"><i class="icon-eye"></i></div>
			</div>
		</div>
	</div>
</div>
<script src="{{asset('frontend_assets')}}/js/vendor-special/lazysizes.min.js"></script>
<script src="{{asset('frontend_assets')}}/js/vendor-special/ls.bgset.min.js"></script>
<script src="{{asset('frontend_assets')}}/js/vendor-special/ls.aspectratio.min.js"></script>
<script src="{{asset('frontend_assets')}}/js/vendor-special/jquery.min.js"></script>
<script src="{{asset('frontend_assets')}}/js/vendor-special/jquery.ez-plus.js"></script>
<script src="{{asset('frontend_assets')}}/js/vendor-special/instafeed.min.js"></script>
<script src="{{asset('frontend_assets')}}/js/vendor/vendor.min.js"></script>
<script src="{{asset('frontend_assets')}}/js/app-html.js"></script>
</body>
</html>
